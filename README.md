...
- **License**: This project is licensed under the [GNU Affero General Public License (AGPL)](https://www.gnu.org/licenses/agpl-3.0.html) with an additional restriction prohibiting commercial use.
